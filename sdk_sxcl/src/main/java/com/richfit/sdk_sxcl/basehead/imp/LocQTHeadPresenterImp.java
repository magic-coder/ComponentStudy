package com.richfit.sdk_sxcl.basehead.imp;
...
import com.richfit.sdk_sxcl.basehead.ILocQTHeadPresenter;
import com.richfit.sdk_sxcl.basehead.ILocQTHeadView;
...
public class LocQTHeadPresenterImp extends BaseHeadPresenterImp<ILocQTHeadView>
        implements ILocQTHeadPresenter {

    ILocQTHeadView mView;

    public LocQTHeadPresenterImp(Context context) {
        super(context);
    }
