...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private HashMap<String, View> mExtraViews;
     ...
     * @param view
     */
    public void addExtraView(String key, View view) {
        if (view == null || mExtraViews == null)
            return;
        mExtraViews.put(key, view);
    }

    /**
     * 获取额外控件
     */
    public View findExtraView(String key) {
        if (TextUtils.isEmpty(key) || mExtraViews == null)
            return null;
        return mExtraViews.get(key);
    }
