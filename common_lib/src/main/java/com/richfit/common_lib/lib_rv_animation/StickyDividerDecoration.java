...
public class StickyDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickyDividerDecoration(Context context) {
    ...
    private int getOrientation(RecyclerView parent) {
        ...
        try {
            ...
            throw new IllegalStateException("StickyDividerDecoration can only be used with a " +
