...
import com.richfit.common_lib.lib_dialog.adapter.TimeLineAdapter;
import com.richfit.common_lib.lib_rv_animation.DividerVerticalTimeLine;
...
public class UploadFragmentDialog extends DialogFragment implements TimeLineAdapter.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rv.addItemDecoration(new DividerVerticalTimeLine(AppCompat.getColor(R.color.blue_a200, getContext()), 60,
                UiUtil.dip2px(getContext().getApplicationContext(),3), AppCompat.getDrawable(getContext(), R.mipmap.icon_timeline_mark)));
