package com.richfit.module_cq.module_rs.impl;
...
/**
 * Created by monday on 2018/2/8.
 */

public class CQRSEditPresenterImpl extends ASEditPresenterImp {

    public CQRSEditPresenterImpl(Context context) {
        super(context);
    }
