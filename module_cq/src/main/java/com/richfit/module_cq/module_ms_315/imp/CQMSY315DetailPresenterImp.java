package com.richfit.module_cq.module_ms_315.imp;
...
public class CQMSY315DetailPresenterImp extends ASDetailPresenterImp {

    public CQMSY315DetailPresenterImp(Context context) {
        super(context);
    }
