package com.richfit.module_cqyt.module_ms.y313.imp;
...
public class CQYTMYS313DetailPresenterImp extends MSDetailPresenterImp {

    public CQYTMYS313DetailPresenterImp(Context context) {
        super(context);
    }
