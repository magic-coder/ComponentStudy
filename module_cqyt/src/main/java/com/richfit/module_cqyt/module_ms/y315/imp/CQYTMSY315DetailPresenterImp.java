package com.richfit.module_cqyt.module_ms.y315.imp;
...
public class CQYTMSY315DetailPresenterImp extends ASDetailPresenterImp {

    public CQYTMSY315DetailPresenterImp(Context context) {
        super(context);
    }
