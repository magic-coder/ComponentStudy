...
import com.richfit.module_cqyt.module_xj.head.CQYTXJHeadContract;
...
public class CQYTWHXJHeadPresenterImp extends BaseHeadPresenterImp<CQYTWHXJHeadContract.View>
        implements CQYTWHXJHeadContract.Presenter {

    CQYTWHXJHeadContract.View mView;

    public CQYTWHXJHeadPresenterImp(Context context) {
        super(context);
    }
