...
public class CQYTWHXJCollectPresenterImp extends BaseCollectPresenterImp<CQYWHTXJCollectContract.View>
        implements CQYWHTXJCollectContract.Presenter {

    public CQYTWHXJCollectPresenterImp(Context context) {
        super(context);
    }
