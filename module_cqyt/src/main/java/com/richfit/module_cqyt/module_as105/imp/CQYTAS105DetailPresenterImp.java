package com.richfit.module_cqyt.module_as105.imp;
...
public class CQYTAS105DetailPresenterImp extends ASDetailPresenterImp {

    public CQYTAS105DetailPresenterImp(Context context) {
        super(context);
    }
