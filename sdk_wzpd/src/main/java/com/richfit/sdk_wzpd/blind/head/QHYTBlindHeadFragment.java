 ...
 */
public class QHYTBlindHeadFragment extends BaseHeadFragment<BlindHeadPresenterImp>
    ...
    protected int getContentId() {
        return R.layout.wzpd_fragment_blind_header;
    }

    @Override
    public void initPresenter() {
        mPresenter = new BlindHeadPresenterImp(mActivity);
    }
    ...
    public void operationOnHeader(String companyCode) {
        ...
        BottomDialogMenuAdapter adapter = new BottomDialogMenuAdapter(mActivity,
                R.layout.item_dialog_bottom_menu, provideDefaultBottomMenu());
