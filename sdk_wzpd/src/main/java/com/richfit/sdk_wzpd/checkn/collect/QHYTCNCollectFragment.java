...
public class QHYTCNCollectFragment extends BaseFragment<CNCollectPresenterImp>
    ...
    protected int getContentId() {
        return R.layout.wzpd_fragment_cn_collect;
    }

    @Override
    public void initPresenter() {
        mPresenter = new CNCollectPresenterImp(mActivity);
    }
