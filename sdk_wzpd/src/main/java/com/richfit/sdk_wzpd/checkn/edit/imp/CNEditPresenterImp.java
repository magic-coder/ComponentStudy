package com.richfit.sdk_wzpd.checkn.edit.imp;
...
import com.richfit.sdk_wzpd.checkn.edit.ICNEditPresenter;
import com.richfit.sdk_wzpd.checkn.edit.ICNEditView;
...
public class CNEditPresenterImp extends BaseEditPresenterImp<ICNEditView>
    ...
    public CNEditPresenterImp(Context context) {
        super(context);
    }
