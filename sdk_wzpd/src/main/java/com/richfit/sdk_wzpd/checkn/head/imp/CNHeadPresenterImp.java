package com.richfit.sdk_wzpd.checkn.head.imp;
...
public class CNHeadPresenterImp extends BaseHeadPresenterImp<ICNHeadView>
        implements ICNHeadPresenter {


    public CNHeadPresenterImp(Context context) {
        super(context);
    }
