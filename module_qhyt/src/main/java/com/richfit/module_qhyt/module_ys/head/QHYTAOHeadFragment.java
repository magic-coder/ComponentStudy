...
import com.richfit.module_qhyt.module_ys.head.imp.QHYTAOHeadPresenterImp;
...
public class QHYTAOHeadFragment extends BaseHeadFragment<QHYTAOHeadPresenterImp>
        implements IQHYTAOHeadView {
    ...
    protected int getContentId() {
        return R.layout.qhyt_fragment_ao_header;
    }

    @Override
    public void initPresenter() {
        mPresenter = new QHYTAOHeadPresenterImp(mActivity);
    }
