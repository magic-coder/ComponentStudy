package com.richfit.module_qhyt.module_ys.detail.imp;
...
import com.richfit.module_qhyt.module_ys.detail.IQHYTAODetailPresenter;
import com.richfit.module_qhyt.module_ys.detail.IQHYTAODetailView;
...
public class QHYTAODetailPresenterImp extends BaseDetailPresenterImp<IQHYTAODetailView>
        implements IQHYTAODetailPresenter {

    public QHYTAODetailPresenterImp(Context context) {
        super(context);
    }
