package com.richfit.module_qhyt.module_as.as105.imp;
...
public class QHYTAS105DetailPresenterImp extends ASDetailPresenterImp {

    public QHYTAS105DetailPresenterImp(Context context) {
        super(context);
    }
    ...
    public void editNode(ArrayList<String> sendLocations, ArrayList<String> recLocations,
        ...
        if (refData != null) {
            ...
            if (treeNode != null && RefDetailEntity.class.isInstance(treeNode)) {
                ...
                int indexOf = getParentNodePosition(refData, parentNode.insLot);
