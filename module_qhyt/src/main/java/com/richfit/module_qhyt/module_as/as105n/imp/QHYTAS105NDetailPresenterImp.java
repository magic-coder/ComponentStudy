package com.richfit.module_qhyt.module_as.as105n.imp;
...
public class QHYTAS105NDetailPresenterImp extends ASDetailPresenterImp {

    public QHYTAS105NDetailPresenterImp(Context context) {
        super(context);
    }
