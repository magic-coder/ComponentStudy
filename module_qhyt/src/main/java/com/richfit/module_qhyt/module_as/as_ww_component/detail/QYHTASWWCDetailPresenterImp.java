...
public class QYHTASWWCDetailPresenterImp extends BaseDetailPresenterImp<QYHTASWWCDetailContract.IQingHaiWWCDetailView>
        implements QYHTASWWCDetailContract.IQingHaiWWCDetailPresenter {


    public QYHTASWWCDetailPresenterImp(Context context) {
        super(context);
    }
    ...
    private List<RefDetailEntity> getLineDatasByRefLineId(RefDetailEntity refLineData,ReferenceEntity cachedRefData) {
        List<RefDetailEntity> results = new ArrayList<>();
        if (refLineData == null) {
            return null;
        }
        ...
        List<RefDetailEntity> list = cachedRefData.billDetailList;
