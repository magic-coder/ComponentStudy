...
public class ScanUtil {
    ...
    //大连石化手持
    private static final String DL_RECT_DATE_ACTION = "Start.Scan.BarCode";
    private static final String DL_START_SCAN_ACTION = "Start.Scan.BarCode";
    private static final String DL_STOP_SCAN_ACTION = "Stop.Scan.BarCode";
