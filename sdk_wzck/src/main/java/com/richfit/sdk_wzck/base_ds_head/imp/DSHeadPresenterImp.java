package com.richfit.sdk_wzck.base_ds_head.imp;
...
import com.richfit.sdk_wzck.base_ds_head.IDSHeadPresenter;
import com.richfit.sdk_wzck.base_ds_head.IDSHeadView;
...
public class DSHeadPresenterImp extends BaseHeadPresenterImp<IDSHeadView>
        implements IDSHeadPresenter {


    public DSHeadPresenterImp( Context context) {
        super(context);
    }
