package com.richfit.sdk_wzck.base_ds_edit.imp;
...
import com.richfit.sdk_wzck.base_ds_edit.IDSEditPresenter;
...
public class DSEditPresenterImp extends BaseEditPresenterImp<IDSEditView>
        implements IDSEditPresenter {

    public DSEditPresenterImp(Context context) {
        super(context);
    }
