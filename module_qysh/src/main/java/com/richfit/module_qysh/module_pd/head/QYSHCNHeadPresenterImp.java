...
public class QYSHCNHeadPresenterImp extends BaseHeadPresenterImp<IQYSHCNHeadView>
        implements IQYSHCNHeadPresenter {

    public QYSHCNHeadPresenterImp(Context context) {
        super(context);
    }
