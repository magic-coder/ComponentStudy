...
public class QHSYAS103DetailAdapter extends CommonTreeAdapter<RefDetailEntity> {


    public QHSYAS103DetailAdapter(Context context, int layoutId, List<RefDetailEntity> allNodes) {
