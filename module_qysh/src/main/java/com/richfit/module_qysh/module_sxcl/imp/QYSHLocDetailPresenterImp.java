package com.richfit.module_qysh.module_sxcl.imp;
...
public class QYSHLocDetailPresenterImp extends LocQTDetailPresenterImp {

    public QYSHLocDetailPresenterImp(Context context) {
        super(context);
    }
