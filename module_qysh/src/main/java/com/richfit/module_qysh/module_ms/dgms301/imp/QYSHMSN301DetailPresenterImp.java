...
public class QYSHMSN301DetailPresenterImp extends MSNDetailPresenterImp {

    public QYSHMSN301DetailPresenterImp(Context context) {
        super(context);
    }
    ...
    public void submitData2BarcodeSystem(String refCodeId, String transId, String bizType, String refType,
        ...
        mView = getView();
        RxSubscriber<String> subscriber = mRepository.uploadCollectionData("", transId, bizType,
                refType, -1, voucherDate, "", userId, extraHeaderMap)
